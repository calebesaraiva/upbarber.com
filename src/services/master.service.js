...
export const getPendingRegistrations = () => masterApi.get(`${M}/registrations`);
export const approveRegistration = (id, body) => masterApi.patch(`${M}/registrations/${id}/approve`, body);
export const rejectRegistration = (id) => masterApi.patch(`${M}/registrations/${id}/reject`);
export const sendMasterNotice = (body) => masterApi.post(`${M}/notices`, body);
export const getInvoicePix = (id) => masterApi.get(`${M}/invoices/${id}/pix`);
...
export const getMasterPlanChangeRequests = () => masterApi.get(`${M}/plan-change-requests`);
export const approveMasterPlanChangeRequest = (id, body = {}) => masterApi.patch(`${M}/plan-change-requests/${id}/approve`, body);
export const rejectMasterPlanChangeRequest = (id) => masterApi.patch(`${M}/plan-change-requests/${id}/reject`);
